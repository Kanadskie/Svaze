...
export default function Contacts() {
  ...
  return (
    <section id="contact" ref={ref} className="section-padding bg-primary relative overflow-x-hidden">
      <div className="container-custom px-3 sm:px-4 md:px-6">
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 sm:gap-5 md:gap-8 lg:gap-10 xl:gap-12">
                ...
                {contacts.map((contact, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-white/80 text-xs sm:text-sm mb-1 truncate">{contact.label}</p>
                      <p className="text-white text-sm sm:text-base md:text-lg font-semibold hover:text-accent transition-colors truncate">
                        {contact.value}
                      </p>
                    </div>
            ...
            >
              <div className="bg-white/5 backdrop-blur-sm p-4 sm:p-5 md:p-6 lg:p-8 rounded-lg sm:rounded-xl border border-white/10">
                <h3 className="text-white text-xl sm:text-2xl md:text-3xl font-bold mb-4 sm:mb-6">
                  Запись на консультацию
                </h3>
                <p className="text-white/80 mb-4 sm:mb-6 md:mb-8 text-sm sm:text-base leading-relaxed">
                ...
                <form className="space-y-3 sm:space-y-4 md:space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-5">
                    <div>
                      ...
                      <input
                        ...
                        id="name"
                        required
                        className="w-full px-3 py-2 sm:px-4 sm:py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/40 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all duration-300 backdrop-blur-sm text-sm sm:text-base"
                  ...
                  <div>
                    <label htmlFor="message" className="block text-xs sm:text-sm font-medium text-white/80 mb-1 sm:mb-2">
                      Сообщение *
                    </label>
                    <textarea
                      id="message"
                      required
                      rows={3}
                      className="w-full px-3 py-2 sm:px-4 sm:py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/40 focus:ring-2 focus:ring-accent focus:border-accent outline-none transition-all duration-300 backdrop-blur-sm resize-vertical text-sm sm:text-base"
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    type="submit"
                    className="w-full bg-gradient-to-r from-accent to-accent-dark text-white py-3 sm:py-4 px-4 rounded-lg font-semibold text-base sm:text-lg hover:from-accent-dark hover:to-accent transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2 sm:gap-3 group"
                  >
